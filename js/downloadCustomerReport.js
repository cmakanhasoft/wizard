...
casper.then(function(){
this.thenOpen("https://sellercentral.amazon.com/gp/ssof/reports/search.html#orderAscending=&recordType=CUSTOMER_RETURNS&noResultType=&merchantSku=&fnSku=&FnSkuXORMSku=&reimbursementId=&orderId=&genericOrderId=&asin=&shipmentId=&problemType=ALL_DEFECT_TYPES&hazmatStatus=&inventoryEventTransactionType=&inventoryAdjustmentReasonGroup", function() {
 });
});
...
casper.then(function() {
    ...
    this.download(ilink, fs.workingDirectory + '/customer_'+customer_count+'.txt');
});
