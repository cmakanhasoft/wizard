...
if(rem_count==0){
     var path= "https://sellercentral.amazon.com/gp/ssof/reports/request-download.html/ref=ag_xx_cont_fbafulrpts?recordType=REIMBURSEMENTS&eventDateTypeFilterOption=orderDate&eventDateOption=0&startDate="+startDate+"&endDate="+endDate+"";
}else {
     var path="https://sellercentral.amazon.com/gp/ssof/reports/request-download.html/ref=ag_xx_cont_fbafulrpts?recordType=REIMBURSEMENTS&eventDateTypeFilterOption=orderDate&eventDateOption=3";
}
console.log(path);
