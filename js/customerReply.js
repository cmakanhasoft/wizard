...
casper.start().thenOpen("http://wizardofamz.com/#/customerReplyView/" + reply_id, function() {
...
casper.thenOpen("https://sellercentral.amazon.com/gp/case-dashboard/view-case.html/ref=sc_cd_lobby_vc?ie=UTF8&caseID="+caseId, function() {
    ...
    this.wait(2000, function () {
        this.capture('customerreplytab.png');
    });
...
casper.then(function () {
          if(this.exists("#replyCase-announce")){
               this.mouse.click("#replyCase-announce");
          }
          this.wait(2000, function () {
