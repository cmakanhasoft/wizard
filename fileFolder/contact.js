...
casper.then(function(){
    this.evaluate(function () {
    $('div.a-row.a-expander-container.scu-section-expander-container').eq(1).find('a.a-link-normal.a-declarative.scu-link-section-expander.a-size-medium').eq(0).click();
    });
